...
| Owner     | Focus                                          | Areas                                                               |
| --------- | ---------------------------------------------- | ------------------------------------------------------------------- |
| Isli Basha | **Data & Intelligence**                        | `data/local`, `data/remote`, `data/worker`, `data/repository`, adaptive engine, notifications |
| Helena Petro | **ML & Camera**                                | `data/ml`, identify & diagnose flows, CameraX pipeline              |
| Serxhio Lekgegaj | **UI & Polish**                                | `ui/theme`, `ui/components`, all `ui/feature/*` screens, widget, onboarding |
